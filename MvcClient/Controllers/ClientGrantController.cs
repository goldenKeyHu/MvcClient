...
{
    public class ClientGrantController : Controller
    {
        // GET: ClientGrantTest
        ...
        public string GetResource()
        {
            ...
            var responseValue = HtpClient.GetAsync("http://localhost:10722/api/values").Result.Content.ReadAsStringAsync().Result;
