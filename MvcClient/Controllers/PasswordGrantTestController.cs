...
{
    public class PasswordGrantTestController : Controller
    {
        ...
        public string GetResource()
        {
            ...
            var responseValue = HtpClient.GetAsync("http://localhost:4282/UserAbout/GetCurrent").Result.Content.ReadAsStringAsync().Result;
            return responseValue;
        }
    }
}